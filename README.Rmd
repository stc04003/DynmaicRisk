...
we provide the following examples in this repository.
  ...
  - [Landmark time is the intermediate event and longitudinal predictors are measured at the intermediate event](https://htmlpreview.github.io/?https://github.com/stc04003/DynmaicRisk/blob/main/Examples/sim3C.html).