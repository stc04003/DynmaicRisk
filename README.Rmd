...
we provide the following examples in this repository.
  ...
  - [Fixed landmark time withlongitudinal predictors measured at the intermediate event](https://htmlpreview.github.io/?https://github.com/stc04003/DynmaicRisk/blob/main/Examples/sim3B.html).
