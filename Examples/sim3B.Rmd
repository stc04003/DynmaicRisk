...
The following codes generate simulated data from `simDat3B()`. 
See vignette on
["generating simulated data"]
(https://htmlpreview.github.io/?https://github.com/stc04003/DynmaicRisk/blob/main/Examples/data.html)
...
See vignette on
[add-on functions for ensemble procedures]
(https://htmlpreview.github.io/?https://github.com/stc04003/DynmaicRisk/blob/main/Examples/addon.html)
