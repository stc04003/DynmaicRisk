---
title: "Landmark time at the intermediate event and the longitudinal predictors measured at the intermediate event."
data: March 9, 2022
...
The functions `simDat()`, `getTrueSurv()`, and `getSurv()` are attached here to make this a stand-alone document. 
Those functions are available in our `code` folder.
