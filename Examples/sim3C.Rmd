...
In addition, the concordance measure can also be used to evaluate the model performance. 
The concordance measure is equivalent to the area under the ROC curve and is implemented as follow: 
```{R}
...
To carry out variable importance, we ...
```{R}
